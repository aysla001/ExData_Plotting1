...
# 1 import data
# 2 update date to remove time
# 2a alternativelt do in strings
# 3 subset data (complete?)
...
plot1 <- function (){
  ...
  hist(as.numeric(datasub$Global_active_power), col = "red", xlab = "Global Active Power (kilowatts)")
